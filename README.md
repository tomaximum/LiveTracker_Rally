...
![Version](https://img.shields.io/badge/version-1.1.0--cloud-blue)
...
La version **v1.1** a été épurée pour supprimer toute dépendance aux serveurs Python locaux (PC/Mac). Tout se passe désormais directement dans votre navigateur :
- **Rapidité** : Chargement instantané via GitHub Pages.
- **Autonomie** : Utilisation directe de l'API Telegram pour le suivi.
- **Fiabilité** : Moins de composants signifie moins de risques de panne.
...
3. **GPX** : Importez votre trace de référence.
...
3. L'application se lancera en plein écran, comme une app native.

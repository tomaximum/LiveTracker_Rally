...
![Version](https://img.shields.io/badge/version-1.1.2--cloud-blue)
...
La version **v1.1.2** est 100% statique. Tout se passe directement dans votre navigateur :
...
- **Persistance** : Utilise **IndexedDB** pour conserver vos roadbooks et l'historique des pilotes, même après un rafraîchissement.

...
![Version](https://img.shields.io/badge/version-2.9.0-alpha--stable-blue)
...
## ✨ Points forts (v2.9.0-alpha)
La version **v2.9.0-alpha** renforce la sécurité des transferts de données et améliore l'interface :
